    ...
    fun getWeatherDataFromDatabase(): WeatherResults {
        ...
        val current = currentWeather?.let {
            WeatherCurrent(
                ...
                roundedTemperature = ConversionHelper.convertRoundedTemperature(it.temperature, settingsManager.getTemperatureUnit()),
                roundedApparentTemperature = ConversionHelper.convertRoundedTemperature(it.apparentTemperature, settingsManager.getTemperatureUnit()),
